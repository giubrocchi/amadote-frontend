    ...
    <div className='formBody'>
      { isDeleteAccountModalOpen &&
        <div className='animalModal'>
          <div className='deleteAccountModalBody'>
            ...
            <input type="password" maxLength="250" className={`signUpInput`} id='deletePassword' value={deletePassword} required placeholder='Senha*' onChange={handleDeletePasswordChange} />
            <div className='deleteButtonsBox'>
              <button type='cancel' className='signUpButton deleteButton' onClick={(e) => changeModalState(e, false)}>
                Cancelar
              </button>
              <button type='cancel' className='signUpButton' onClick={deleteAccount}>
                {!loadingDelete && 'Confirmar'}
                {loadingDelete && <ThreeDots height='21' radius='9' color="#1C3144" ariaLabel="three-dots-loading"/>}
              </button>
            </div>
          </div>
        </div>
      ...
      { !isChangingPassword &&
        <form className='signUpForm' onSubmit={handleSubmit}>
          ...
          <input type="text" maxLength="2" className={`signUpInput invalid${invalidState}`} required={hasAddress} id='state' value={state} placeholder='UF' onChange={handleStateChange} />
          ...
          <button type='cancel' className='signUpButton deleteButton' style={{marginTop: '40px'}} onClick={(e) => changeModalState(e, true)}>
            Deletar conta
          </button>
        </form>
      }
      { isChangingPassword &&
        <form className='signUpForm' onSubmit={changePassword}>
          ...
          <input type="password" maxLength="250" className={`signUpInput`} id='changePassword' value={password} required placeholder='Senha atual*' onChange={handlePasswordChange} />
          ...
          <input type="password" maxLength="250" className={`signUpInput inputWithTip`} id='newPassword' value={newPassword} required placeholder='Nova senha*' onChange={handleNewPasswordChange} />
          ...
          <div className='deleteButtonsBox'>
            <button type='cancel' className='signUpButton deleteButton' style={{marginTop: '40px'}} onClick={() => showChangePassword(false)}>
              Cancelar
            </button>
            <button type='submit' className='signUpButton' style={{marginTop: '40px'}}>
              {!loadingChangePw && 'Salvar'}
              {loadingChangePw && <ThreeDots height='21' radius='9' color="#1C3144" ariaLabel="three-dots-loading"/>}
            </button>
          </div>
        </form>
      }
