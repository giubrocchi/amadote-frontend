  ...
  return (
    <div className="animalModal">
      <div className="animalModalBody">
        <button className="animalModalClose" onClick={() => editAnimal('', false)}>
          X
        </button>
        ...
        <form className="signUpForm" onSubmit={handleSubmit}>
          <div className="editImagesBox">
            {previousPhotos.map((url, index) => {
              return (
                <div className="editImageContainer" key={index}>
                  <img className="editImage" src={url} alt="Animal" />
                  <button
                    className="editImageExclude"
          ...
          <Select
            ...
            required
            placeholder="Espécie*"
            value={{ value: specie, label: specie }}
          ...
          <Select
            ...
            required
            placeholder="Sexo*"
            value={{ value: animalSex, label: animalSex }}
          ...
          <div className="animalModalLabel">
            ...
            <input
              ...
              onChange={() => handleVaccinatedChange(true)}
              required
            />
            ...
            <input
              ...
              onChange={() => handleVaccinatedChange(false)}
            />
          ...
          <div className="animalModalLabel">
            ...
            <input
              ...
              onChange={() => handleCastratedChange(true)}
              required
            />
            <label className="animalModalLabelText">Sim</label>
            <input
              ...
              onChange={() => handleCastratedChange(false)}
            />
            <label className="animalModalLabelText">Não</label>
          </div>
          <div className="animalModalLabel">
            ...
            <input
              ...
              onChange={() => handleSpecialChange(true)}
              required
            />
            <label className="animalModalLabelText">Sim</label>
            <input
              ...
              onChange={() => handleSpecialChange(false)}
            />
            <label className="animalModalLabelText">Não</label>
          </div>
          <div className="animalModalLabel">
            ...
            <input
              type="radio"
              name="microchip"
              checked={microchip === true}
              onChange={() => handleMicrochipChange(true)}
              required
            />
            <label className="animalModalLabelText">Sim</label>
            <input
              type="radio"
              name="microchip"
              checked={microchip === false}
              onChange={() => handleMicrochipChange(false)}
            />
            <label className="animalModalLabelText">Não</label>
          </div>
        ...
        <div className="deleteButtonsBox">
          ...
          <button
            ...
            onClick={() => deleteAnimal('adoptedByOtherMeans')}
          >
